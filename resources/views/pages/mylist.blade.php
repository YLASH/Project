                ...
                <div class="tab-pane " id="tab_1">
                    <div class="container">
                        ...
                        <table class="table table-hover">
                            ...
                            @if($product->pstatus =='hidden')
                            <tr class="table-secondary">
                                <td><a href="/mylist/{{$uid}}_{{$product->pid}}"><img src="/storage/{{$product->filename}}" height="60px" width="60px">{{$product->pname}}</a></td>
                                <td> </td>
                            ...
                            <tr>
                                ...
                                @endif
                                <!--<td><a href='edit/{{$product->pid}}' style="color: inherit;"><center>Edit</center></a></td> <a href='/delete/{{$product->pid}}/' style="color: inherit;"><center>Delete</center></a>-->
                                <td>
                                    <button onclick="delfood('{{$product->pname}}','{{$product->pid}}')">Delete</button>
                                </td>
                            </tr>
                            @endforeach
                        </table>
...
<script>
    ...
    function delfood(pname, pid) {
        var r = confirm(`Delete ${pname}?? `);
        if (r == true) {
