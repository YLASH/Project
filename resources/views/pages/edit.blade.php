    ...
    <div class="card" style="float: left; height:30%; width:40%;margin: 0px 1% 2% 1%;">
        <div class="card-body">
            <form id="stuff" action="/up/{{$pid}}" method="post" enctype="multipart/form-data">
                ...
                <label for="fotoup">Upload a cute shot of your food</label>
                <!--upload image-->
                ...
                <div>
                    ...
                    <select id=pstatus name="pstatus" required>
                        <optgroup label="Availability">
                            <option value="showing">Available</option>
                            <option value="hidden">Hide Item</option>
                        </optgroup>
                    </select>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <input type="tetx" name="loca" placeholder="Collection Point" value="{{$pickplace}}">
                            <!--insert map--><br>
                        </li>
                    ...
                    <br>
                    <input onclick="editsub()" type=submit value="submit">
